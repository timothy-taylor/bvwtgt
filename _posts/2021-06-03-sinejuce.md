...
The std::sin function accepts one argument that represents the angle in radians. So let's add that the private variables in our MainComponent along with a couple other helpful variables and a new slider for frequency:
```
