...
I want to note how the provided [{ scripting specifications documentation }]({{ site.data.links.scriptingspecs }}) will provide the skeleton and most of the basic information for info.lua, realtime_controller.lua, motherboard_ref.lua, hdgui_2D.lua, etc.
